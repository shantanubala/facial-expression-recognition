...
Table \ref{Tab:FaceExpRecog} below shows a compilation of the state-of-the-art in facial expression recognition algorithms. Note that the table is an extension of the 2009 work that was published by Zaho et. al. [REF].
...
\chapter{DELIVERING DYADIC INTERACTION CUES THROUGH VIBROTACTILE STIMULATIONS}
...
use to develop more robust face recognition algorithms. Later in Chapter XXX, we described the interface to deliver the face recognition results to the user's who are blind.
...
\includepdf[pages={1,2,5,6,7,8,9,10,11}, fitpaper=true]{ACS.pdf}

...
\end{enumerate}
Below, these three items are discussed in detail providing a high level discussion on the nature of their influence on the non-verbal communication between individuals.

\subsection{The Communication Environment} \label{SubSec:1.3.1}
...
Due to the fact that a large portion of human-human interpersonal communication happens through complex non-verbal cueing, individuals who are disabled face myriad levels of difficulty when it comes to interpreting and responding to everyday social interactions. The difficulty varies based on the kind of disability and the intensity of the disability one faces. Non-verbal cues are mostly interpretative, and not instructive as verbal cues (such as speech) are.  In a bilateral interpersonal interaction, while speech encodes all the information, non-verbal cues facilitate the delivery and interpretation of the verbal information. People with sensory, perceptual, motor and cognitive disabilities might not be able to receive or process these non-verbal cues effectively. Though individuals with such disabilities often learn to make accommodations for the lack of a particular primary information channel, the learning of effective accommodations could be positively effected if the social signals that they receive could be enriched. This book focuses on the development of technologies that can facilitate interpersonal interactions for people who are disabled. We specifically focus on the issues emanating from the lack of \emph{sensory visual stimuli}, like in the case of people who are blind or visually impaired.

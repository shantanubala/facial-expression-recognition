...
In the concluding remarks, this book engages the readers into a science and technology policy debate on the potential effect of a new technology like the social interaction assistant on the society. Discussing along the policy lines, social disability is highlighted as an important area that require special attention from researchers and policy makers. Given that the proposed technology reies on wearable inconspicuous cameras, the discussion of privacy policies is extended to encompass such newly evolving interpersonal interaction recorders.
